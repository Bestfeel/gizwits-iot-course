...
'''
参数说明
protocol 协议：tcp、http
hostname 自定义域名，平台上选择自定义域名的时候填写，需要和平台上的一致
subdomain 前置域名，平台上选择前置域名的时候填写，需要和平台上的一致
rport 远程端口，TCP模式使用，需要和平台上的一致
lhost 映射的ip地址，本机使用127.0.0.1，可以是局域网其他ip，如果在自己电脑映射路由器 192.168.1.1
lport 映射端口，修改成自己要映射的端口，例如80，或者22

如果需要同时启动多个隧道则
'''
body['protocol'] = 'http' 
body['hostname'] = 'www.baidu.com'
body['subdomain'] = ''
body['rport'] = 0
...
body1['protocol'] = 'http' 
body1['hostname'] = ''
body1['subdomain'] = 'test'
body1['rport'] = 0
body1['lhost'] = '127.0.0.1'
body1['lport'] = 80
